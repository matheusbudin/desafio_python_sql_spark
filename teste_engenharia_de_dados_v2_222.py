...
Bom dia pessoal, neste e-mail, temos como solicitado, o desafio em formato HTML. Porém gostaria de deixar como back up o link para o github que também possui a solução desenvolvida, e também, o hisórico de commits (caso necessário). E, também, anexo o arquivo à este e-mail

##link: https://github.com/matheusbudin/desafio_python_sql_spark/blob/main/teste_engenharia_de_dados_v2_222.ipynb
"""
